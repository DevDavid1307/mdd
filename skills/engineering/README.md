...
Reachable only when you type them (`disable-model-invocation: true` for Claude Code, `policy.allow_implicit_invocation: false` in `agents/openai.yaml` for Codex).
